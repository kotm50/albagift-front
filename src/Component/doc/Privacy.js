      ...
      <div>
        ...
        <p>
          <strong>
            ...
            &gt;('{props.url}'이하 '
            {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}
            ')&nbsp; 은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
        ...
        <ul>
          ...
          <li>관련법령 : 계약 또는 청약철회 등에 관한 기록 : 1년</li>
          <li>예외사유 :</li>
        </ul>
        <p>
        ...
        <ul>
          <li>1&lt; 홈페이지 회원가입 및 관리&gt;</li>
          <li>
            회원가입시 : 아이디, 비밀번호, 이메일, 카카오계정(소셜계정 한정)
          </li>
          <li>
            본인인증시 : 이름, 성별, 생년월일, 휴대폰번호, CI, DI, 내/외국인
            정보
          </li>
        </ul>
        <p>
        ...
        <p>
          ①&nbsp; &lt;
          {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}
          &gt;은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위
        ...
        <p>
          ...
          하는 경우에는, 해당 개인정보를 암호화하여 보관합니다
        </p>
        <p>1. 법령 근거 :</p>
        <p>2. 보존하는 개인정보 항목 : 포인트 지급, 포인트 사용</p>
        <p>③ 개인정보 파기의 절차 및 방법은 다음과 같습니다.</p>
        <p>1. 파기절차</p>
        <p>
          &lt;{props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}&gt;
          은(는) 파기 사유가 발생한 개인정보를 선정하고, &lt;
          {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}&gt; 의
        ...
        <p>
          ① 정보주체는 알바선물에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는알바선물에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}
        ...
        <p>
          ⑥ {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}은(는)
        ...
        <p>
          ① 알바선물 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
        ...
        <p>
          &lt;{props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}&gt;
          은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보
        ...
        <p>
          이에 따라 &lt;
          {props.domainName === "xn--352blzj6r" ? "알바몰" : "알바선물"}&gt;
          가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기 위해서 다음과
          같은 사항을 고려하였습니다.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>직책 :운영지원</li>
          <li>직급 :부장</li>
          <li>연락처 :010-9898-7776</li>
        </ul>
        <p>※ 개인정보 보호 담당부서로 연결됩니다.</p>
        <p>
          ② 정보주체께서는 알바선물 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 알바선물
          은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
        </p>
        <p>
          <strong>제14조(개인정보의 열람청구를 접수·처리하는 부서)</strong>
        </p>
        <p>
          <strong>
        ...
        <p>
          <strong>제15조(정보주체의 권익침해에 대한 구제방법)</strong>
        </p>
        <p>
        ...
        <p>
          <strong>제16조(개인정보 처리방침 변경)</strong>
        </p>
