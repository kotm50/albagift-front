...
function Privacy() {
  return (
    <>
      <div>
        <p>
          &lt;코리아티엠&gt;('https://koreatm.cf'이하 '코리아티엠')&nbsp; 은(는)
        ...
        <p>
          <strong>
            &lt;코리아티엠&gt;('https://koreatm.cf'이하 '코리아티엠')&nbsp;
        ...
        <p>
          ...
          제공, 본인인증, 연령인증을 목적으로 개인정보를 처리합니다.
        </p>
        <p>4. 마케팅 및 광고에의 활용</p>
        <p>
        ...
        <p>
          ①&nbsp;&lt;코리아티엠&gt;&nbsp;은(는) 다음의 개인정보 항목을 처리하고
          있습니다.
        </p>
        <ul>
          <li>1&lt; 홈페이지 회원가입 및 관리&gt;</li>
          <li>필수항목 : 휴대전화번호, 성별, 생년월일, 이름</li>
          <li>선택항목 : 기념일, 결혼여부, 취미, 학력</li>
        </ul>
        <p>
          <strong>제4조(개인정보의 제3자 제공에 관한 사항)</strong>
        </p>
        <p>
          ①&nbsp; &lt;코리아티엠&gt;은(는) 개인정보를 제1조(개인정보의 처리
          목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의
          특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는
          경우에만 개인정보를 제3자에게 제공합니다.
        </p>
        <p>
          ②&nbsp;&lt;코리아티엠&gt;&nbsp;은(는) 다음과 같이 개인정보를 제3자에게
          제공하고 있습니다.
        </p>
        <ul>
          <li>1. &lt; 주식회사 코리아티엠&gt;</li>
          <li>개인정보를 제공받는 자 : 주식회사 코리아티엠</li>
          <li>
        ...
        <p>
          ① &lt;코리아티엠&gt; 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
        ...
        <p>1. 파기절차</p>
        <p>
          &lt;코리아티엠&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
          &lt;코리아티엠&gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다.
        </p>
        <p>2. 파기방법</p>
        <p>
        ...
        <p>
          ① 정보주체는 코리아티엠에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p>
          ② 제1항에 따른 권리 행사는코리아티엠에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 코리아티엠은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p>
        ...
        <p>
          ⑥ 코리아티엠은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <p>
          <strong>
            &lt;코리아티엠&gt;&nbsp;은(는) 개인정보의 안전성 확보를 위해 다음과
            같은 조치를 취하고 있습니다.
          </strong>
        </p>
        <p>1. 정기적인 자체 감사 실시</p>
        ...
        <p>
          ① 코리아티엠 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
        ...
        <p>
          <strong>제11조(추가적인 이용·제공 판단기준)</strong>
        </p>
        <p>
          &lt;코리아티엠&gt; 은(는) ｢개인정보 보호법｣ 제15조제3항 및
          제17조제4항에 따라 ｢개인정보 보호법 시행령｣ 제14조의2에 따른 사항을
          고려하여 정보주체의 동의 없이 개인정보를 추가적으로 이용·제공할 수
          있습니다.
        </p>
        <p>
          이에 따라 &lt;코리아티엠&gt; 가(이) 정보주체의 동의 없이 추가적인
        ...
        <p>
          &lt;코리아티엠&gt; 은(는) 다음과 같은 목적으로 가명정보를 처리하고
          있습니다.
        </p>
        <p>▶ 가명정보의 처리 목적</p>
        <p>- 직접작성 가능합니다.</p>
        ...
        <p>
          ①&nbsp;코리아티엠&nbsp;은(는) 개인정보 처리에 관한 업무를 총괄해서
        ...
        <ul>
          ...
          <li>직책 :운영지원</li>
          <li>직급 :부장</li>
          <li>연락처 :010-9898-7776, koreatm0@nate.com,</li>
        </ul>
        <p>※ 개인정보 보호 담당부서로 연결됩니다.</p>
        <p>
          ② 정보주체께서는 코리아티엠 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 코리아티엠
        ...
        <p>
          ...
          코리아티엠&gt;의 국내대리인에게 개인정보 관련 고충처리 등의 업무를
          위하여 연락을 취할 수 있습니다. &lt;코리아티엠&gt;은(는) 정보주체의
          개인정보 관련 고충처리 등 개인정보 보호책임자의 업무 등을 신속하게
          처리할 수 있도록 노력하겠습니다.
        </p>
        <p>
          ▶ &lt;코리아티엠&gt; 은(는) ｢개인정보 보호법｣ 제39조의11에 따라
          국내대리인을 지정하였습니다.
        </p>
        <p>
        ...
        <p>
          - 국내대리인의 주소 : [대리인 주소_직접입력] (법인의 경우 영업소
          소재지)
        </p>
        <p>- 국내대리인의 전화번호 : [대리인 전화번호_직접입력]</p>
        <p>- 국내대리인의 전자우편 주소 : [대리인 전자우편_직접입력]</p>
        <p>
          <strong>제15조(개인정보의 열람청구를 접수·처리하는 부서)</strong>
        </p>
        <p>
          <strong>
        ...
        <p>
          <strong>
            &lt;코리아티엠&gt;은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.
          </strong>
        </p>
        <p>
        ...
        <p>
          <strong>제17조(개인정보 처리방침 변경)</strong>
        </p>
